    ...
    <div className="about">
      ...
      <div className="about__wrapper">
        <p className="about__description">
          ...
          starting in Atlanta, GA and ending in Boston, MA. Take a look below at
          the route we have created for you and the fun events along the way.
          Please click on the event to purchase a ticket. Bon Voyage!
        </p>
        <img
          src={aboutPhoto}
